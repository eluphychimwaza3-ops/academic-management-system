...
import { LayoutDashboard, Users, FileText, BookOpen, BarChart3, Settings, LogOut, Menu, X } from "lucide-react"
      ...
      >
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center gap-3">
            <Image src={ExploitsLogo} alt="Exploits University" width={40} height={40} className="rounded-lg object-cover" /> Admin
          </div>
        </div>
