...
import { LayoutDashboard, BookOpen, FileText, BarChart3, Users, LogOut, Menu, X } from "lucide-react"
...
const navItems = [
  ...
  { href: "/lecturer/grading", label: "Grading", icon: BarChart3 },
  { href: "/lecturer/students", label: "Students", icon: Users },
  { href: "/lecturer/subjects", label: "Subjects", icon: BookOpen },
]
      ...
      >
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center gap-3">
            <Image src={ExploitsLogo} alt="Exploits University" width={40} height={40} className="rounded-lg object-cover" /> Lecturer
          </div>
        </div>
